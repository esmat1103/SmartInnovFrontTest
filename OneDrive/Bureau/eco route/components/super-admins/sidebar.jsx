...
import admin from'@/public/sidebar_icons/admin.svg';
import adminWhite from'@/public/sidebar_icons/adminW.svg';
            ...
            <div className="sidebar poppins">
                ...
                <nav className="mt-10 mx-3  ">
                    <ul className=' poppins '>
                        <li className={`mb-3 ${activePath === '/superadmins/dashboard' ? 'active' : ''}`}>
                            <Link href="/superadmins/dashboard" className="items-center flex ">
                              <Image src={activePath === '/superadmins/dashboard' ? dashboardW : monitor} alt='monitor' width={23}  className='hauto ml-4' id="monitor-icon" />
                                <p className="f14 fw500 mt1 ml4">Dashboard</p>
                              <Image src={chevron1} alt='chevron' width={20}  className='icon hauto ml-auto'/>
                            </Link>
                        </li>
                        <li className={`mb-3 ${activePath === '/superadmins/admins' ? 'active' : ''}`}>
                            <Link href="/superadmins/admins" className="flex items-center">
                               <Image src={activePath === '/superadmins/admins' ? adminWhite : admin} alt='admin' width={20}  className='hauto' id="admin-icon" />
                                <p className="f14 fw500 ml4 ">Admins</p>
                                <Image src={chevron1} className='icon ml-auto hauto'  width={20}   alt='chevron'/>
                            </Link>
                        </li>
                        <li className={`mb-3 ${activePath === '/superadmins/bins' ? 'active' : ''}`}>
                            <Link href="/superadmins/bins" className="flex items-center">
                            <Image src={activePath === '/superadmins/bins' ? binWhite : bin} alt='bin' width={20}  id="bin-icon" className='mr-4 hauto'/>
                                <p className="f14 fw500 ml4 ">Bins</p>
                                <Image src={chevron1} alt='chevron'  width={20}  className=' hauto icon ml-auto'/>
                            </Link>
                        </li>
                        <li className={`mb-3 ${activePath === '/superadmins/employees' ? 'active' : ''}`}>
                            <Link href="/superadmins/employees" className="flex items-center">
                               <Image src={activePath === '/superadmins/workers' ? employeesWhite : employees} alt='employees' width={20}  className='hauto' id="employee-icon" />
