...
const HomeSA = ({ devices,admins,clients,sensors}) => {
    return (
        <>
            <h1 className="pl-2 fw600 nunito  white pt-5 f30 mb-5 ">Dashboard Overview</h1>
            {/* <div className='pl-2 filter-bar flex mb-2 mt-2'>
                <Image src={filter} alt='filter' width={20} height={20} />
                <p className='white mx-2 nunito f14'> Filter : </p>
                ...
                <p className='sidebargrey nunito f14 ml-5'>Dates :</p>
                <p className='white nunito ml-2 f14'>Year 2022 </p>
                <Image src={chevronD} alt='square' width={10} height={20} className='ml-2' />
                <p className='sidebargrey nunito ml-5 f14'>Status :</p>
            ...
            <div className='flex'>
                <div className='pl-2 mx-1'>
                    <StatBox1 admins={admins} />
                </div>
                <div className='mx-1'>
                    <StatBox2  clients={clients}/>
                </div>
                <div className='mx-1'>
